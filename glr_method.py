...
def find_ways(grammar, nonterm, pos, i, graph, matrix, states, states_init, states_number, work):
        ...
        for nonterm in grammar.start:
            for pos in grammar.start[nonterm]:
                for i in range(size_graph):
                    find_ways(grammar, nonterm, pos, i, graph, matrix, states, states_init, states_number, work)
